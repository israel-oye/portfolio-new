        ...
        <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project, index) => (
                    <motion.div
                        ...
                        className="group relative bg-secondary/20 border border-border rounded-xl overflow-hidden hover:border-primary/50 transition-all hover:-translate-y-1 flex flex-col hover:shadow-xl hover:shadow-primary/5"
                    >
                        {/* Hover Pattern */}
                        <div
            ...
            <div className="mt-12 text-center">
                <Button variant="outline" size="lg" asChild>
                    <Link href="https://github.com/israel-oye" target="_blank">
                        View More on GitHub
                    </Link>
                </Button>
            </div>
